  ...
  const decorate=()=>{
    ...
    document.querySelectorAll('.project').forEach((card,i)=>{
      ...
      if(!controls){
        ...
        controls.innerHTML='<button type="button" class="project-expand-btn" aria-label="Rozwiń podgląd projektu"><span>⌄</span></button><button type="button" class="project-open-btn">Otwórz projekt <span>→</span></button>';
