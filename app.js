...
let projects=JSON.parse(localStorage.getItem('pereko_projects')||'null')||structuredClone(defaultProjects),tasks=JSON.parse(localStorage.getItem('pereko_tasks')||'null')||structuredClone(defaultTasks),activeFilter='work',cloudSyncEnabled=true,remoteReady=false,syncTimer=null,pendingLocalChanges=false,remotePushInFlight=false,remoteLoadInFlight=false,lastRemoteUpdatedAt='';
