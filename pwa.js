(()=>{
  ...
  function iosGuide(){
    return '<div class="pwa-guide"><strong>Instalacja na iPhonie:</strong><ol><li>Otwórz stronę w Safari.</li><li>Stuknij ikonę Udostępnij.</li><li>Wybierz „Dodaj do ekranu początkowego”.</li><li>Potwierdź „Dodaj”, a potem uruchom aplikację z ikony PEREKO.</li></ol></div>';
  }
  ...
  async function testNotification(){
    ...
    if(!registration)await registerSW();
    if(registration){
      await registration.showNotification('PEREKO — Centrum Marketingowe',{body:'Powiadomienia działają poprawnie na tym urządzeniu.',icon:'/icons/pwa-192.png',badge:'/icons/badge-96.png',tag:'pereko-local-test',data:{url:'/'}});
  ...
  function showInstallOnboarding(){
    ...
    onboarding.querySelector('#pwaOnboardText').textContent='Uruchamiaj system z własnej ikony i przygotuj telefon do odbierania powiadomień o projektach i zadaniach.';
